...
gitmap merge-right ./gitmap-v3 https://github.com/alimtvnetwork/gitmap-v4 -y
...
```
  [mv] resolving LEFT  : ./gitmap-v3 (folder, exists)
  [mv] resolving RIGHT : https://github.com/alimtvnetwork/gitmap-v4
  [mv]   -> mapped to working folder: ./gitmap-v4
  ...
  [mv]   commit 9a3c1e2 "gitmap mv from ./gitmap-v3"
  [mv] pushing RIGHT ...
  [mv]   push OK
  [mv] done
```
