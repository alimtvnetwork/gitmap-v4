...
export const commands: CommandDef[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    examples: [
      { command: "gitmap mv ./gitmap-v3 ./gitmap-v4", description: "Move local folder into another local folder, deleting source" },
  ...
  },
  {
    ...
    examples: [
      { command: "gitmap merge-both ./gitmap-v3 ./gitmap-v4", description: "Interactive two-way merge between two local folders" },
  ...
  },
  {
    ...
    examples: [
      { command: "gitmap merge-left ./gitmap-v4 ./gitmap-v3", description: "Pull RIGHT's changes into LEFT (interactive prompt)" },
  ...
  },
  {
    ...
    examples: [
      { command: "gitmap diff ./gitmap-v3 ./gitmap-v4", description: "Plain text diff of two local folders" },
