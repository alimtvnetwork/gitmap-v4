...
// Legacy bookmark table name (for migration detection only).
...
// SQL: bookmark operations (v15: Bookmark table, BookmarkId PK).
const (
...
// SQL: import-side bookmark insert (v15-aware "INSERT OR IGNORE" for import.go).
